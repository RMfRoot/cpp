...
RobotonyRequestForm::RobotonyRequestForm() : AForm("robotony request", 72, 45), _target("none") {}
...
AForm	*RobotonyRequestForm::clone(std::string target)
{
	return (new RobotonyRequestForm(target));
}